...
export default function Home() {
  ...
  return (
    <div>
      <main className="flex min-h-screen bg-second-black text-primary-white p-24 items-center justify-around gap-12">
      ...
      <main className="flex min-h-screen bg-white text-primary-black p-24 flex-col gap-12">
        <div className="flex flex-col gap-4">
          <h2 className="text-5xl" >EXEMPLOS</h2>
          <h3 className="text-2xl" >Solucione qualquer problema com a nossa ajuda</h3>
        </div>
        <AboutCards cards={cards}></AboutCards>
      </main>
      <main className="flex min-h-screen bg-second-black text-primary-white p-24 gap-12 w-full">
        <div className="flex flex-col w-1/2 text-5xl gap-8 justify-center items-center">
          <div>S</div>
          <div>Y</div>
          <div>N</div>
          <div>T</div>
        ...
        <div className="flex flex-col gap-40 justify-center text-right">
          <h2 className="text-5xl text-right" >QUEM SOMOS</h2>
          <article className="flex flex-col gap-8 text-2xl">
            <p>
